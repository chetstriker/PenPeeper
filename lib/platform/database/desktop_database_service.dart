...
/// Desktop implementation of database service using sqflite_ffi
class DesktopDatabaseService implements DatabaseService {
  Database? _database;
  ...
  Future<void> _onUpgrade(Database db, int oldVersion, int newVersion) async {
    // Migration logic from database_helper.dart
    if (oldVersion < 2) {
      await db.execute('''
        CREATE TABLE scans (
          id INTEGER PRIMARY KEY AUTOINCREMENT,
